...
#'
#' @return \code{IDEA} returns a list containing the following components:  \code{Rhat} is the estimate of R0  and \code{inputs} is a list of the original input variables \code{NT, mu}.  
#'
#' @examples
#' 
#' ## ===================================================== ##
